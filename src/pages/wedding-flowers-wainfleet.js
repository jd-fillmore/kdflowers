...
const IndexPage = () => (
  <Layout>
    <SEO title="Wedding Flowers &amp; Florist in Wainfleet | Affordable Bridal Bouquets" />
    <Nav />
    <Hero
      title="Wedding Flowers &amp; Florist in Wainfleet | Affordable Bridal Bouquets"
      subTitle="Quality wedding flowers &amp; bridal bouquets serving Wainfleet at an affordable price"
      btnText="Book A Consult"
    />
    <Intro
      title="Wainfleet Wedding Flowers &amp; Bridal Bouquets"
      text="KD Flowers wedding floral design focuses on one goal - creating lasting beautiful memories by designing personalized, elegant and lavish wedding flowers for brides and grooms all over Wainfleet. Designing and creating wedding flowers is my passion and I do my best to make sure your wedding flowers reflect your style and love for each other. I work to capture all your wedding fantasies and make them a dream come true!"
      btnText="View Portfolio"
      imgAlt="wedding flowers Wainfleet, Wainfleet florist"
    />
    <About
