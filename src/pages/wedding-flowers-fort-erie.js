...
const IndexPage = () => (
  <Layout>
    <SEO title="Wedding Flowers &amp; Florist in Fort Erie | Affordable Bridal Bouquets" />
    <Nav />
    <Hero
      title="Wedding Flowers &amp; Florist in Fort Erie | Affordable Bridal Bouquets"
      subTitle="Quality wedding flowers &amp; bridal bouquets serving Fort Erie at an affordable price"
      btnText="Book A Consult"
    />
    <Intro
      title="Fort Erie Wedding Flowers &amp; Bridal Bouquets"
      text="KD Flowers wedding floral design focuses on one goal - creating lasting beautiful memories by designing personalized, elegant and lavish wedding flowers for brides and grooms all over Fort Erie. Designing and creating wedding flowers is my passion and I do my best to make sure your wedding flowers reflect your style and love for each other. I work to capture all your wedding fantasies and make them a dream come true!"
      btnText="View Portfolio"
      imgAlt="wedding flowers Fort Erie, Fort Erie florist"
    />
    <About
